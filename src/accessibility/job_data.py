from util import set_paths, get_lodes_file, restrict_to_Baltimore
...
def compute_job_totals(seg = "S000", year = '2020', lodes_type = 'wac'):
    ...
    job_data['mid_job_totals'] = job_data['CE01'] + job_data['CE02']

    job_data = job_data[[geo_col, "job_totals", "mid_job_totals"]]
